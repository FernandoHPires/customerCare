        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Process Foreclouse</h5>
                ...
                <div class="modal-body">
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <tr>
                                <td>Original Foreclouse Amount</td>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-success" type="button" @click="confirm()"
                        :disabled="amountReceived <= 0 || paymentReceivedDate === null"
                    >
...
export default {
    ...
    data() {
        return {
            modalId: 'confirmationForeclosureAmount',
            event: '',
            dialogMessage: '',
